 ...
 */
public class DecEncCtsCaseThread extends AndroidTestCase {
    private static final String TAG = "DecEncCtsCaseThread";
    ...
    private static class BufferToSurfaceWrapper implements Runnable {
        ...
        private DecEncCtsCaseThread mTest;
        private BufferToSurfaceWrapper(DecEncCtsCaseThread test) {
            mTest = test;
        }
        @Override
        public void run() {
         ...
         * @param obj
         */
        public static void runTest(DecEncCtsCaseThread obj) throws Throwable {
    ...
    private static class SurfaceToSurfaceWrapper implements Runnable {
        private Throwable mThrowable;
        private DecEncCtsCaseThread mTest;
        private SurfaceToSurfaceWrapper(DecEncCtsCaseThread test) {
            mTest = test;
        }
        @Override
        public void run() {
    ...
    private void doEncodeDecodeVideoFromBuffer(MediaCodec encoder, int encoderColorFormat,
        ...
        if (DEBUG_SAVE_FILE) {
            ...
            try {
                ...
                Log.w(TAG, "Unable to create debug output file " + fileName+" msg:"+ioe.getMessage());
